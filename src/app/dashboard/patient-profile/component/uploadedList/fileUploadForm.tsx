...
//         // ---------------- Drive Upload ----------------
//         const response = await fileAPI.submitRecordWithFile(formData);
...
//                 <Image src={f.preview} alt={f.name} className="max-h-40 w-full object-contain rounded" width={300}               // ✅ required
//                     height={200}      />
