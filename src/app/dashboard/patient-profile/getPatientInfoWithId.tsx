...
//           );
//         }
//         setSurgicalData(data.surgical_data ?? []);
//         setPostOpsData(data.post_ops_data ?? []);
//         setPreOpsData(data.pre_ops_data ?? []);
//       } catch (err: unknown) {
//         if (err instanceof Error) setError(err.message);
//         else setError("Failed to load patient profile");
//       }
//     });
//   }, [patient_id, admission_id]);
...
//       <div className="max-w-6xl mx-auto px-1 sm:px-3 md:px-1 py-1 space-y-1">
//         {/* Patient Basic Info */}
//         <PatientDetails
//           patient={selectedPatient}
//           // admissionData={latestAdmission}
...
//         {/* Tabs Section */}
//         <Tabs defaultValue="medical-history" className="mt-2">
//           <PatientTabs />
//           <MedicalHistoryTab
//             pre_ops_data={preOpsData}
//             surgical_data={surgicalData}
...
//                   Doctor or nurse notes will appear here.
//                 </p>
//               </CardContent>
//             </Card>
//           </TabsContent>
